...
while i <= count:
    ...
    if age < 0:
        ...
        s += 0  # Понятно что строчка лишняя, но дла красоты кода оставим
        i += 1
    elif age < 25:
...
if count > 3:
    ...
    print(f'Сумма к оплате за {count} билета(ов) {s * 0.9} руб.')
else:
    print(f'Сумма к оплате за {count} билет(а) {s } руб.')
